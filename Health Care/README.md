...
## Simplified MLOps Implementation

A lightweight, production-ready machine learning system for predicting heart attack risk, featuring simplified MLOps capabilities without heavy tooling.
